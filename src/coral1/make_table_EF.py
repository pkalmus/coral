...
Based on make_table.py which is old, and was for the original Nature submission that was rejected.
This is for the Earth's Future submission.
...
outstr = outstr+'\caption{Projected years and GMSTAs after which fewer than the stated percentage of 1 km$^2$ reef locations remain below the thermal thresholds}\n'


outstr = outstr+'\\begin{tabular}{ccccccccccccc}\n'
outstr = outstr+'	\hline\n'

outstr = outstr+'	& \multicolumn{3}{c}{5Y 8 DHW$_{2008}$ } & \multicolumn{3}{c}{10Y 8 DHW$_{2008}$ } & \multicolumn{3}{c}{5Y 8 DHW$_{1988}$ } & \multicolumn{3}{c}{10Y 8 DHW$_{1988}$ } \\\\ \n'
outstr = outstr+'	\hline\n'
outstr = outstr+'	SSP & 30\% & 10\% & 1\% & 30\% & 10\% & 1\% & 30\% & 10\% & 1\% & 30\% & 10\% & 1\% \\\\ \n'
outstr = outstr+'	\hline\hline\n'
outstr = outstr+'	\multicolumn{13}{c}{Year in twenty-first century }\\\\ \n'
outstr = outstr+'	\hline\n'
...
# do it for temps
outstr = outstr+'	\multicolumn{13}{c}{Global mean surface temperature (\\degreec) }\\\\ \n'
outstr = outstr+'	\hline\n'
for (ind, scenario) in enumerate(scenarios): # reload each file 4 times, once per scenario
...
outstr = '\\begin{table}[ht]\n'
outstr = outstr+'\centering\n'
outstr = outstr+'\caption{Percentages and numbers of reef locations remaining below the stated thresholds}\n'
...
outstr = outstr+'	& \multicolumn{3}{c}{5Y 8 DHW$_{2008}$ } & \multicolumn{3}{c}{10Y 8 DHW$_{2008}$ } & \multicolumn{3}{c}{5Y 8 DHW$_{1988}$ } & \multicolumn{3}{c}{10Y 8 DHW$_{1988}$ } \\\\ \n'
outstr = outstr+'	\hline\n'
outstr = outstr+'	 & 1.5\\degreec & 1.7\\degreec & 2.0\\degreec & 1.5\\degreec & 1.7\\degreec & 2.0\\degreec  & 1.5\\degreec & 1.7\\degreec & 2.0\\degreec  & 1.5\\degreec & 1.7\\degreec & 2.0\\degreec  \\\\ \n'
outstr = outstr+'	\hline\hline\n'    
# do it for percentages above 1.5, 1.7, 2.0
outstr = outstr+'	\multicolumn{13}{c}{Percent 1 km$^2$ reef locations remaining below threshold }\\\\ \n'
outstr = outstr+'	\hline\n'
for (ind, scenario) in enumerate(scenarios): # reload each file 4 times, once per scenario
    if ind==0: # no GMST for ssp126
        continue
...
outstr = outstr+'	\multicolumn{13}{c}{Number of 1 km$^2$ reef locations remaining below threshold, out of 828,639 }\\\\ \n'
outstr = outstr+'	\hline\n'
for (ind, scenario) in enumerate(scenarios): # reload each file 4 times, once per scenario
    if ind==0: # no GMST for ssp126
        continue
